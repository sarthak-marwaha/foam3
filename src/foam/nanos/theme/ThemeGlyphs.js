  ...
  properties: [
    ...
    },
    {
      ...
      factory: function() {
        ...
        <path d="M6.69773 0.710022C7.08773 1.10002 7.08773 1.73002 6.69773 2.12002L2.81774 6.00002L6.69773 9.88002C7.08773 10.27 7.08773 10.9 6.69773 11.29C6.30773 11.68 5.67773 11.68 5.28773 11.29L0.697734 6.70002C0.307734 6.31002 0.307734 5.68002 0.697734 5.29002L5.28773 0.700022C5.66773 0.320022 6.30773 0.320022 6.69773 0.710022Z"/>
        </svg>
        `
        };
      }
    },
    {
      ...
      factory: function() {
        return { template: `
        <svg width="100%" viewBox="0 0 6 12" fill="/*%FILL%*/ #ffffff" xmlns="http://www.w3.org/2000/svg">
        <path d="M0.317891 0.710022C-0.0721094 1.10002 -0.0721094 1.73002 0.317891 2.12002L4.19789 6.00002L0.317891 9.88002C-0.0721094 10.27 -0.0721094 10.9 0.317891 11.29C0.707891 11.68 1.33789 11.68 1.72789 11.29L6.31789 6.70002C6.70789 6.31002 6.70789 5.68002 6.31789 5.29002L1.72789 0.700022C1.34789 0.320022 0.707891 0.320022 0.317891 0.710022Z"/>
        </svg>
        `
        };
      }
    },
    {
      ...
      factory: function() {
        ...
        <path d="M6.69773 0.293762C7.08773 0.683762 7.08773 1.31376 6.69773 1.70376L2.81774 5.58376L6.69773 9.46376C7.08773 9.85376 7.08773 10.4838 6.69773 10.8738C6.30773 11.2638 5.67773 11.2638 5.28773 10.8738L0.697734 6.28376C0.307734 5.89376 0.307734 5.26376 0.697734 4.87376L5.28773 0.283762C5.66773 -0.0962379 6.30773 -0.0962377 6.69773 0.293762Z" />
        <path d="M13.2925 0.293762C13.6825 0.683762 13.6825 1.31376 13.2925 1.70376L9.4125 5.58376L13.2925 9.46376C13.6825 9.85376 13.6825 10.4838 13.2925 10.8738C12.9025 11.2638 12.2725 11.2638 11.8825 10.8738L7.2925 6.28376C6.9025 5.89376 6.9025 5.26376 7.2925 4.87376L11.8825 0.283762C12.2625 -0.0962379 12.9025 -0.0962377 13.2925 0.293762Z" />
        </svg>
        `
        };
      }
    },
    {
      ...
      factory: function() {
        return { template: `
        <svg width="100%" viewBox="0 0 14 12" fill="/*%FILL%*/ #ffffff" xmlns="http://www.w3.org/2000/svg">
        <path d="M0.2925 11.7062C-0.0975 11.3162 -0.0975 10.6862 0.2925 10.2962L4.1725 6.41624L0.2925 2.53624C-0.0975 2.14624 -0.0975 1.51624 0.2925 1.12624C0.6825 0.736237 1.3125 0.736237 1.7025 1.12624L6.2925 5.71624C6.6825 6.10624 6.6825 6.73624 6.2925 7.12624L1.7025 11.7162C1.3225 12.0962 0.6825 12.0962 0.2925 11.7062Z"/>
        <path d="M6.88726 11.7062C6.49726 11.3162 6.49726 10.6862 6.88726 10.2962L10.7673 6.41624L6.88726 2.53624C6.49726 2.14624 6.49726 1.51624 6.88726 1.12624C7.27726 0.736237 7.90726 0.736237 8.29726 1.12624L12.8873 5.71624C13.2773 6.10624 13.2773 6.73624 12.8873 7.12624L8.29726 11.7162C7.91726 12.0962 7.27726 12.0962 6.88726 11.7062Z"/>
        </svg>
        `
        };
      }
      ...
      factory: () => {
        return { template: `
          <svg width="100%" viewBox="0 0 20 20" fill="/*%FILL%*/ #ffffff" xmlns="http://www.w3.org/2000/svg">
            <path d="M9.99 0C4.47 0 0 4.48 0 10C0 15.52 4.47 20 9.99 20C15.52 20 20 15.52 20 10C20 4.48 15.52 0 9.99 0ZM14.23 16L10 13.45L5.77 16L6.89 11.19L3.16 7.96L8.08 7.54L10 3L11.92 7.53L16.84 7.95L13.11 11.18L14.23 16Z"/>
          </svg>
        ` };
      }
    },
    ...
    },
    {
      ...
      factory: () => {
        ...
        <path d="M3 4.84376C2.99999 3.01318 3 0.312509 3 0.156259C3 9.25362e-06 2.99999 9.91716e-06 2.5 9.8152e-06C2 9.71324e-06 2 1.0998e-05 2 0.156261C2 0.312511 2 3.01318 2 4.84376C2 5.00001 2.06338 5.00001 2.49999 5.00001C2.93661 5.00001 3 5.00001 3 4.84376Z"/>
        <path d="M0.999942 4.84375C0.999934 3.01317 0.999941 0.312499 0.999943 0.156249C0.999944 -6.83472e-07 0.999933 -7.20942e-09 0.499937 -1.09169e-07C-6.01113e-05 -2.11128e-07 -5.79357e-05 1.06096e-06 -5.86578e-05 0.156251C-5.93799e-05 0.312501 -5.7643e-05 3.01317 -5.7909e-05 4.84375C-5.79317e-05 5 0.0633186 5 0.499934 5C0.936552 5 0.999943 5 0.999942 4.84375Z"/>
        </svg>
        ` };
      }
    },
    ...
    },
    {
      ...
      factory: () => {
        ...
        <rect x="6" y="7" width="18" height="4" rx="2" />
        <rect x="3" y="14" width="24" height="4" rx="2" />
        </svg>        
        ` };
      }
    },
    {
      ...
      factory: () => {
        ...
        <svg width="100%" viewBox="0 0 30 18" fill="/*%FILL%*/ #FFFFFF" xmlns="http://www.w3.org/2000/svg">
        <rect width="30" height="4" rx="2" />
        <rect y="7" width="18" height="4" rx="2" />
        <rect y="14" width="24" height="4" rx="2" />
        </svg>        
        ` };
      }
    },
    {
      ...
      factory: () => {
        ...
        <rect x="6" y="14" width="24" height="4" rx="2" />
        </svg>
        ` };
      }
    },
    {
      ...
      factory: () => {
        return { template: `
        <svg width="100%" viewBox="0 0 30 18" fill="/*%FILL%*/ #FFFFFF" xmlns="http://www.w3.org/2000/svg">
        <rect x="4" width="23" height="4" rx="2" />
        <rect y="18" width="18" height="3" rx="1.5" transform="rotate(-90 0 18)" />
        <rect x="4" y="7" width="26" height="4" rx="2" />
        <rect x="4" y="14" width="21" height="4" rx="2" />
        </svg>
        ` };
      }
    },
    {
      ...
      factory: () => {
        ...
        <rect x="5" y="1" width="22" height="4" rx="2" />
        <rect x="5" y="8" width="25" height="4" rx="2" />
        <rect x="5" y="15" width="20" height="4" rx="2" />
        <path d="M0.564 5V4.274H1.692V1.466H1.638L0.786 2.582L0.21 2.132L1.212 0.812H2.592V4.274H3.48V5H0.564Z" />
        <path d="M3.306 12H0.342V11.178L1.632 10.074C1.748 9.974 1.846 9.884 1.926 9.804C2.006 9.72 2.07 9.64 2.118 9.564C2.17 9.484 2.206 9.406 2.226 9.33C2.25 9.254 2.262 9.172 2.262 9.084V9C2.262 8.92 2.246 8.85 2.214 8.79C2.182 8.73 2.14 8.68 2.088 8.64C2.036 8.6 1.976 8.57 1.908 8.55C1.844 8.53 1.778 8.52 1.71 8.52C1.61 8.52 1.522 8.536 1.446 8.568C1.374 8.6 1.31 8.644 1.254 8.7C1.202 8.752 1.158 8.814 1.122 8.886C1.086 8.954 1.058 9.028 1.038 9.108L0.252 8.808C0.3 8.664 0.366 8.528 0.45 8.4C0.534 8.268 0.638 8.154 0.762 8.058C0.89 7.958 1.04 7.88 1.212 7.824C1.384 7.768 1.578 7.74 1.794 7.74C2.022 7.74 2.224 7.772 2.4 7.836C2.576 7.9 2.724 7.988 2.844 8.1C2.968 8.212 3.062 8.346 3.126 8.502C3.19 8.654 3.222 8.82 3.222 9C3.222 9.18 3.192 9.344 3.132 9.492C3.072 9.64 2.99 9.78 2.886 9.912C2.786 10.04 2.668 10.162 2.532 10.278C2.396 10.394 2.254 10.512 2.106 10.632L1.326 11.244H3.306V12Z"/>
        <path d="M1.572 16.468C1.796 16.468 1.958 16.426 2.058 16.342C2.162 16.254 2.214 16.146 2.214 16.018V15.976C2.214 15.824 2.164 15.702 2.064 15.61C1.968 15.518 1.83 15.472 1.65 15.472C1.482 15.472 1.324 15.516 1.176 15.604C1.028 15.688 0.902 15.81 0.798 15.97L0.234 15.442C0.314 15.338 0.4 15.244 0.492 15.16C0.584 15.072 0.688 14.998 0.804 14.938C0.92 14.874 1.05 14.826 1.194 14.794C1.338 14.758 1.5 14.74 1.68 14.74C1.904 14.74 2.106 14.766 2.286 14.818C2.47 14.87 2.626 14.946 2.754 15.046C2.886 15.142 2.986 15.258 3.054 15.394C3.126 15.53 3.162 15.682 3.162 15.85C3.162 15.982 3.14 16.102 3.096 16.21C3.056 16.318 2.998 16.412 2.922 16.492C2.85 16.572 2.766 16.638 2.67 16.69C2.574 16.738 2.472 16.772 2.364 16.792V16.828C2.488 16.852 2.602 16.892 2.706 16.948C2.814 17 2.906 17.068 2.982 17.152C3.062 17.236 3.124 17.336 3.168 17.452C3.212 17.564 3.234 17.692 3.234 17.836C3.234 18.024 3.196 18.194 3.12 18.346C3.044 18.498 2.936 18.628 2.796 18.736C2.656 18.844 2.488 18.928 2.292 18.988C2.096 19.044 1.88 19.072 1.644 19.072C1.432 19.072 1.244 19.05 1.08 19.006C0.916 18.962 0.772 18.904 0.648 18.832C0.528 18.756 0.422 18.67 0.33 18.574C0.242 18.478 0.164 18.376 0.096 18.268L0.762 17.752C0.854 17.924 0.966 18.066 1.098 18.178C1.234 18.286 1.416 18.34 1.644 18.34C1.848 18.34 2.006 18.29 2.118 18.19C2.234 18.086 2.292 17.946 2.292 17.77V17.734C2.292 17.562 2.226 17.434 2.094 17.35C1.966 17.262 1.788 17.218 1.56 17.218H1.182V16.468H1.572Z"/>
        </svg>
        ` };
      }
    },
    {
      ...
      factory: () => {
        return { template: `
        <svg width="100%" viewBox="0 0 30 18" fill="/*%FILL%*/ #FFFFFF" xmlns="http://www.w3.org/2000/svg">
        <rect x="5" width="22" height="4" rx="2" />
        <rect x="5" y="7" width="25" height="4" rx="2" />
        <rect x="5" y="14" width="20" height="4" rx="2" />
